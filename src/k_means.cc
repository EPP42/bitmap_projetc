...
void Kmean::colored_sigma() noexcept
{
    ...
    for (auto i = 0; i < cluster_; i++)
    {
        ...
        colored_means_[i].v = colored_means_[i].v ? colored_means_[i].v / colored_cluster_[i].size() : 0;
        colored_means_[i].r = colored_means_[i].r ? colored_means_[i].r / colored_cluster_[i].size() : 0;
        colored_means_[i].b = colored_means_[i].b ? colored_means_[i].b / colored_cluster_[i].size() : 0;
        colored_means_[i].x = colored_means_[i].x ? colored_means_[i].x / colored_cluster_[i].size() : 0;
        colored_means_[i].y = colored_means_[i].y ? colored_means_[i].y / colored_cluster_[i].size() : 0;
...
void Kmean::nb_sigma() noexcept
{
    for (auto i = 0; i < cluster_; i++)
    {
        ...
        nb_means_[i].v = nb_means_[i].v ? nb_means_[i].v / nb_cluster_[i].size() : 0;
        nb_means_[i].x = nb_means_[i].x ? nb_means_[i].x / nb_cluster_[i].size() : 0;
        nb_means_[i].y = nb_means_[i].y ? nb_means_[i].y / nb_cluster_[i].size() : 0;
    }
}
